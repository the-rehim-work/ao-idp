    ...
    <div style={{ minHeight: '100vh', background: '#000', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem', fontFamily: '"JetBrains Mono", "Courier New", monospace', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ width: '100%', maxWidth: 340, position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 52, height: 52, border: `1px solid ${BORDER}`, background: '#0f141b', marginBottom: '0.875rem', boxShadow: GLOW }}>
        ...
        <div style={{ background: '#0f141b', border: `1px solid ${BORDER}`, padding: '2rem', boxShadow: '0 0 30px rgba(94,234,212,0.08), inset 0 0 30px rgba(94,234,212,0.02)' }}>
