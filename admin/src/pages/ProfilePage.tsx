  ...
  return (
    <div style={{ maxWidth: 520 }}>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <h1 style={{ fontSize: '1.125rem', fontWeight: 700, color: C, letterSpacing: '0.08em', textTransform: 'uppercase', textShadow: '0 0 8px rgba(94,234,212,0.5)' }}>Profile</h1>
      </div>
      ...
      <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, padding: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '1rem' }}>
          <button
            style={{ padding: '0.6rem 1.25rem', background: 'transparent', border: `1px solid ${canSubmit ? C : CM}`, color: canSubmit ? C : CM, fontFamily: 'inherit', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', cursor: canSubmit ? 'pointer' : 'default', boxShadow: canSubmit ? '0 0 8px rgba(94,234,212,0.3)' : 'none' }}
